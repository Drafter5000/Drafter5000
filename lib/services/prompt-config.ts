...
export const VARIABLE_DESCRIPTIONS: Record<SupportedVariable, string> = {
  job_title: "User's job title (e.g., 'LinkedIn content creator', 'Senior Product Manager')",
  existing_topics: 'Formatted list of existing topic ideas the user has already created',
