...
export function Hero3D() {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      >
        <div
          className="w-full h-full rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/20 backdrop-blur-sm shadow-xl"
      ...
      >
        <div
          className="w-full h-full rounded-xl bg-gradient-to-br from-chart-2/20 to-chart-2/5 border border-chart-2/20 backdrop-blur-sm shadow-lg"
      ...
      >
        <div
          className="w-full h-full rounded-lg bg-gradient-to-br from-chart-5/20 to-chart-5/5 border border-chart-5/20 backdrop-blur-sm shadow-md"
